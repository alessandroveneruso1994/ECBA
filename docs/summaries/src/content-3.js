...

{
  ...
  blocks: [
    ...
    { t: 'h3', v: '7.2 I ruoli stakeholder generici' },
    ...
    { t: 'h3', v: '7.3 Facilitare la collaborazione' },
    ...
    { t: 'h3', v: '7.4 Motivazioni e driver' },
...

{
  ...
  blocks: [
    ...
    { t: 'h3', v: '8.1 Outcome e obiettivi' },
    ...
    { t: 'h3', v: '8.2 Opportunità e barriere al valore' },
    ...
    { t: 'h3', v: '8.3 Comunicare come la soluzione raggiunge gli obiettivi' },
    { t: 'p', v: 'Sequenza dei cinque task di Solution Evaluation: 8.1 Measure (definisci e raccogli) → 8.2 Analyze (trasforma i dati in insight sulla prestazione rispetto al valore) → 8.3 e 8.4 Assess Limitations (interne ed esterne) → 8.5 Recommend Actions.' },
    { t: 'p', v: 'Dati raccolti senza analisi non producono decisioni: è la distinzione fra 8.1 e 8.2 che l\'esame mette alla prova.' },

    { t: 'h3', v: '8.4 Metriche e KPI (10.28)' },
...

{
  ...
  blocks: [
    ...
    { t: 'h3', v: '9.1 Validare la qualità dell\'informazione' },
    ...
    { t: 'h3', v: '9.2 Riconoscere i vincoli' },
    ...
    { t: 'h3', v: '9.4 Standard e framework di settore' },
